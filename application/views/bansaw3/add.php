  ...
  <div class="col-md-4">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <?php echo form_open('bansaw3/add','role="form" class="form-horizontal"'); ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="number" placeholder="No Log" id="form-field-1" class="form-control" name="no" value="<?php echo ($this->input->post('no_log') ? $this->input->post('no_log') : $this->Bansaw3_model->get_number($this->session->userdata('no_bpk'))); ?>" >
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="number" id="form-field-2" class="form-control" value="<?php echo $this->input->post('diameter'); ?>" name="diameter"
              autofocus="">
            </div>
          </div>
          <div class="form-group">
...
<div class="col-md-4">
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <i class="fa fa-external-link-square"></i>
      DATA Log bansaw 3 : <?php echo ($this->input->post('no_log') ? $this->input->post('no_log') : $this->Bansaw3_model->get_number($this->session->userdata('no_bpk'))-1); ?>
      <div class="panel-tools">
        <a class="btn btn-xs btn-link panel-collapse collapses" href="#">
        </a>
        <a class="btn btn-xs btn-link panel-config" href="#panel-config" data-toggle="modal">
