...
<html lang="en" class="no-js">
	...
	<body class="login example2">
		<div class="main-login col-sm-4 col-sm-offset-4">
			<div class="logo">APLIKASI<i class="clip-clip"></i>PT. SUMBER ALAM
			</div>
			<!-- start: LOGIN BOX -->
			<div class="box-login">
				...
				<i class="fa fa-remove-sign"></i> Terjadi Kdsf Login
				</div>
				<?php } ?>
          <?php echo form_open('auth/chek_login','class="form-login"'); ?>
					<div class="errorHandler alert alert-danger no-display">
						<i class="fa fa-remove-sign"></i> Terjadi Kesalahan Login, Silahkan perikasa kembali.
					</div>
		...
		<script src="http://localhost/log/assets/plugins/jquery-validation/dist/jquery.validate.min.js"></script>
		<script src="http://localhost/log/assets/js/login.js"></script>
