          ...
          <div style="margin:20px;">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <?php echo form_open('bpk_satpam/edit/'.$bpk['no_bpk'],'role="form" class="form-horizontal"'); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="number" placeholder="No HP Supplier" id="form-field-8" class="form-control" name="no_hp" value="<?php echo ($this->input->post('no_hp') ? $this->input->post('no_hp') : $bpk['no_hp']); ?>" class="form-control" id="no_hp" />
						        ...
						        <div class="col-sm-9">
						          <input type="number" placeholder="No HP Sopir" id="form-field-8" class="form-control" name="no_hp" value="<?php echo ($this->input->post('no_hp_sopir') ? $this->input->post('no_hp_sopir') : $bpk['no_hp_sopir']); ?>" class="form-control" id="no_hp" />
						        </div>
						      </div>
                  <div class="form-group">
