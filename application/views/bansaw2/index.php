<div class="page-header">
  <h4>MONITORING LOG <small>bansaw 2</small></h4>
</div>
<?php
  ...
  <div class="col-md-4">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <?php echo form_open('excel_bansaw2/upload','role="form" class="form-horizontal" enctype="multipart/form-data"'); ?>
    ...
    <a class="btn btn-primary btn-sm" href="<?php echo site_url('bansaw2/add/'.$this->session->userdata('no_bpk')); ?>"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah item</a>
    <a class="btn btn-danger btn-sm" href="<?php echo site_url('bansaw2/removeall/'.$this->session->userdata('no_bpk')); ?>"><span class="glyphicon glyphicon-trash"></span>&nbsp;&nbsp;Delete all</a><br><br>
    <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
                <a href="<?php echo site_url('bansaw2/edit/'.$b['id']); ?>" class="btn btn-info btn-sm"><span class="fa fa-pencil"></span></a>
                <a href="<?php echo site_url('bansaw2/remove/'.$b['id']); ?>" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span></a>
            </td>
        </tr>
        <?php } ?>
      </tbody>
