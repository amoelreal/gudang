<div class="page-header">
  <h4>MONITORING LOG <small>rotary</small></h4>
</div>
<?php
  ...
  <div class="col-md-4">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <?php echo form_open('excel_rotary/upload','role="form" class="form-horizontal" enctype="multipart/form-data"'); ?>
    ...
    <a class="btn btn-primary btn-sm" href="<?php echo site_url('log_rotary/add/'.$this->session->userdata('no_bpk')); ?>"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah item</a>
    <a class="btn btn-danger btn-sm" href="<?php echo site_url('log_rotary/removeall/'.$this->session->userdata('no_bpk')); ?>"><span class="glyphicon glyphicon-trash"></span>&nbsp;&nbsp;Delete all</a><br><br>
